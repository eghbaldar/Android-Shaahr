...
Partial Class usercontrol_SpecialApp
    ...
    Public Function getLogo(ByVal logo As Object) As String
        ...
        Else
            Return ResolveUrl("~/CopyLogo.aspx?P=" + logo.ToString.Trim + "&W=45&H=45")
        End If
    End Function
    Public Function getShortDetail(ByVal title As Object) As String
        If title.ToString.Length > 100 Then
            Return title.ToString.Substring(0, 100)
        Else
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        lblDay.Text = String.Format(" نرم افزارهای مناسبتی {0}", Class_.getEnableDay)
    End Sub
End Class
